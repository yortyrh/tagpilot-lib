...
let __wasmFilePath = __nodePath.join(__dirname, 'tagpilot_lib.wasm32-wasi.wasm')
const __wasmDebugFilePath = __nodePath.join(__dirname, 'tagpilot_lib.wasm32-wasi.debug.wasm')

if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  __wasmFilePath = __wasmDebugFilePath
} else if (!__nodeFs.existsSync(__wasmFilePath)) {
  try {
    __wasmFilePath = __nodePath.resolve('@yortyrh/tagpilot-lib-wasm32-wasi')
  } catch {
    throw new Error(
      'Cannot find tagpilot_lib.wasm32-wasi.wasm file, and @yortyrh/tagpilot-lib-wasm32-wasi package is not installed.',
    )
  }
}
...
module.exports.AudioImageType = __napiModule.exports.AudioImageType
module.exports.ApiAudioImageType = __napiModule.exports.ApiAudioImageType
